<x-layouts.app :title="'Create Campaign'">
    ...
    <form method="POST" action="{{ route('campaigns.store') }}" class="space-y-6" x-data="campaignForm()">
        @csrf
        ...
        <div class="flex justify-end space-x-3">
            <a href="{{ route('campaigns.index') }}" class="px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50">Cancel</a>
            <button type="submit" class="px-4 py-2 text-sm font-medium text-white bg-indigo-600 rounded-md hover:bg-indigo-700">Create Campaign</button>
        </div>
    </form>
