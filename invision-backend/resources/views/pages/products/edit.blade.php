<x-layouts.app title="Edit Product">
    ...
    <form method="POST" action="{{ route('products.update', $product) }}" class="bg-white shadow rounded-lg p-6 space-y-6">
        @csrf @method('PUT')
        ...
        <div class="flex justify-end gap-3">
            <a href="{{ route('products.show', $product) }}" class="px-4 py-2 border border-gray-300 text-gray-700 rounded-md text-sm hover:bg-gray-50">Cancel</a>
            <button type="submit" class="px-4 py-2 bg-indigo-600 text-white rounded-md text-sm hover:bg-indigo-700">Update Product</button>
        </div>
    </form>
</x-layouts.app>
